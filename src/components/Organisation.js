          ...
          <ul className="namesOfSubjects">
            <li>
              <div className="leftSiteList">
                <p className="mainTextList">Organizacja “Lorem Ipsum 1”</p>
            ...
            <li>
              <div className="leftSiteList">
                <p className="mainTextList">Organizacja “Lorem Ipsum 2”</p>
                <p className="secondTextList">
            ...
            <li className="lastListName">
              <div className="leftSiteList">
                <p className="mainTextList">Organizacja “Lorem Ipsum 3”</p>
                <p className="secondTextList">
